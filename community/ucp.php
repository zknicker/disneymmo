...
if ($module->is_active('zebra', 'friends'))
{
	...
	$sql = $db->sql_build_query('SELECT_DISTINCT', array(
		...
		// Modify the select statement to also return the user's avatar.
        'SELECT'	=> 'u.user_id, u.username, u.username_clean, u.user_colour, u.user_avatar, u.user_avatar_type, u.user_avatar_width, u.user_avatar_height, MAX(s.session_time) as online_time, MIN(s.session_viewonline) AS viewonline',
	...
	while ($row = $db->sql_fetchrow($result))
	{
		...
		$template->assign_block_vars("friends_{$which}", array(
            ...
            'AVATAR_PATH'   => dmmo_get_user_avatar_path($row['user_avatar'], $row['user_avatar_type']),
