...
class phpbb_default_captcha
{
	...
	var $daropl_fieldname;
	var $daropl_fieldname_hash;
	...
	function init($type)
	{
		...
		$this->daropl_fieldname = sha1(time() . rand());
		$this->daropl_fieldname_hash = request_var(sha1($config['cookie_name'] . $config['record_online_date']), '');
		$this->confirm_code = request_var($this->daropl_fieldname_hash, '');
	...
	function get_template()
	{
		...
		else
		{
			...
			$template->assign_vars(array(
				...
				'S_DAROPL_FIELDNAME'		=> $this->daropl_fieldname,
				'S_DAROPL_SALT'				=> sha1($config['cookie_name'] . $config['record_online_date']),
				'S_DAROPL_FIELDSIZE'		=> rand(8, 20),
			));
	...
	function get_hidden_fields()
	{
		...
		global $config;
		$hidden_fields[sha1($config['cookie_name'] . $config['record_online_date'])] = $this->daropl_fieldname;
